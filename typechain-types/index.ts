...
export type { DidLabToken } from "./contracts/CampusCredit.sol/DidLabToken";
export { DidLabToken__factory } from "./factories/contracts/CampusCredit.sol/DidLabToken__factory";
